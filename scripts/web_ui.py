...
let forceRotation=setInterval(()=>{if(resourceGraph){let controls=resourceGraph.controls();controls.autoRotate=true;controls.autoRotateSpeed=.45;clearInterval(forceRotation)}},250);
