...
neuralCanvas.height=340;setInterval(morphNeuralNetwork,80);requestAnimationFrame(drawNeuralReference);load().catch(e=>document.body.insertAdjacentHTML('beforeend','<pre>'+esc(e.message)+'</pre>'));setInterval(refreshResources,10000)
</script></html>"""
